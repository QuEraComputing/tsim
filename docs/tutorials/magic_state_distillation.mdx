...
<iframe src="/images/tutorials/magic_state_distillation/diagram_001.html" width="100%" height="104" style={{border: "1px solid #eee", borderRadius: "0.5rem"}} title="Circuit diagram 1" loading="lazy" />
...
<iframe src="/images/tutorials/magic_state_distillation/diagram_002.html" width="100%" height="104" style={{border: "1px solid #eee", borderRadius: "0.5rem"}} title="Circuit diagram 2" loading="lazy" />
...
<iframe src="/images/tutorials/magic_state_distillation/diagram_003.html" width="100%" height="244" style={{border: "1px solid #eee", borderRadius: "0.5rem"}} title="Circuit diagram 3" loading="lazy" />
...
<iframe src="/images/tutorials/magic_state_distillation/diagram_004.html" width="100%" height="504" style={{border: "1px solid #eee", borderRadius: "0.5rem"}} title="Circuit diagram 4" loading="lazy" />
