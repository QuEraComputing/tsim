---
title: "Contributing"
description: "How to set up your development environment, run tests, and contribute to tsim."
---

Please see [Installation](/install) for instructions on how to set up your development environment.
...
We use `just` for managing command-line tools and scripts. It should be installed when you run `uv sync`. The documentation site is built with [Mintlify](https://mintlify.com/); the local Mintlify CLI is installed separately via npm:
